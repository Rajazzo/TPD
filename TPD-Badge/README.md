...
Die Badges für alle 65 Mentoren (Stand 12.03.2026) sind in der Datei [index.html](index.html) zusammengefasst. ([Ansicht](http://htmlpreview.github.io/?https://github.com/Rajazzo/TPD/blob/main/TPD-Badge/index.html))

Die QR-Codes der einzelnen Mentoren wurden dabei über die [Treffpunkt Management App](https://treffpunkt-managment-app.pages.dev/dashboard/register_mentor) einzeln in das Verzeichnis [qr-code](./qr-codes/) exportiert. Jeder QR Code ist dabei mit dem Vornamen und ersten Buchstaben des Nachnamens des jeweiligen Mentors benannt.
...
Solte eine Karte im Hochformat für einen Labeldrucker benötigt werden, ist ein Beispiel dazu in der Datei [brother_ql-800.html](brother_ql-800.html) und [brother_ql-800.css](brother_ql-800.css) hinterlegt.
([Ansicht](http://htmlpreview.github.io/?https://github.com/Rajazzo/TPD/blob/main/TPD-Badge/brother_ql-800.html))