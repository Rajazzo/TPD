...
Die Badges für alle 65 Mentoren (Stand 12.03.2026) sind in der Datei index.html zusammengefasst. Die QR-Codes der einzelnen Mentoren wurden dabei über die [Treffpunkt Management App](https://treffpunkt-managment-app.pages.dev/dashboard/register_mentor) einzeln in das Verzeichnis [qr-code](./qr-codes/) exportiert. Jeder QR Code ist dabei mit dem Vornamen und ersten Buschstaben des Nachnamens des jeweiligen Mentors benannt.
...
Im dazugehörigen <i>style.css</i> ist das Layout für jede dieser <i>.card</i> Abschnitte definiert. Wesentliche Elemente sind die absoluten Maße der Karte (8,5 x 5,5 cm) sowie die Ausrichtung der Elemente über ein sogenanntes "grid" Layout.
